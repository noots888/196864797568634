var App={
  version:'map-app-v3-1-86_GPS_ARROW',
  versionShort:'Map_APP-V3.1.86 GPS_ARROW' ,
  baseLock:{name:'Map_APP-V3.1.86 GPS_ARROW',intent:'Builds connected circuit paths from exact imported line/nameplate references, not guessed route stubs or hardcoded data.'},
